...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(220, 30, 351, 41))
        font = QtGui.QFont()
        ...
        # Dòng tên tác giả ở giữa
        self.label_author = QtWidgets.QLabel(self.centralwidget)
        self.label_author.setGeometry(QtCore.QRect(250, 80, 300, 20))
        font_author = QtGui.QFont()
        font_author.setPointSize(10)
        font_author.setItalic(True)
        self.label_author.setFont(font_author)
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(180, 120, 411, 81))
        self.txt_plain_text.setObjectName("txt_plain_text")

        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(180, 300, 411, 101))
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(200, 430, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")

        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(500, 430, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")

        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(180, 220, 411, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_author.setText(_translate("MainWindow", "Lê Thanh Hoàng Đức - 2280600720"))
